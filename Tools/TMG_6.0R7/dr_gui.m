        ...
        if get(handles.maxlPDDP, 'Value')==1, 
            ...
            if tmp>k,
                if get(handles.CLSIRadio, 'Value')==1, 
                     err_pddp=new_sprintf('Number of principal components for PDDP you supplied produces more than %d clusters (number of factors for CLSI). Please alter your selection...', k);  
                else, 
                     err_pddp=new_sprintf('Number of principal components for PDDP you supplied produces more than %d clusters (number of factors for CM). Please alter your selection...', k); 
                end
